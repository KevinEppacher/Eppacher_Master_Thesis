...
% Accordingly, this chapter reviews relevant prior work at the intersection of geometric exploration, vision-language-guided exploration, semantic mapping and object detectors. First, approaches to geometric exploration and vision-language-guided exploration are discussed, highlighting how semantic cues are incorporated into exploration strategies. Second, methods for building and maintaining persistent semantic maps are examined, with a focus on representation choices and long-term memory. Finally, recent advances in object detection and promptable vision-language models are reviewed, providing the semantic foundations upon which hybrid exploration systems are built.
...
These methods differ in architecture and learning paradigm but share a common goal deriving navigation policies from semantic visual understanding..
