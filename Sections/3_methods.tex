...
% \begin{itemize}
%     \item The BT interfaces with the robot's navigation stack to execute movement commands, such as calling
%     the \texttt{/navigate_to_pose} service or performing spin-in-place actions.
%     \item In this work, the MPPI Local Planner \cite{mppi_local_planner} is used for navigation.
%     \item The BT monitors navigation status and handles failures or replanning as needed.
% \end{itemize}


\textbf{Action and Condition Nodes}
