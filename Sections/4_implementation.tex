...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Amount of episodes per scene
...
\textbf{Experiment 5: Robustness to False Positives (Fusion Strategy):}  
Evaluated using semantic precision and false positive rate. Assesses the effect of the fusion strategy on filtering erroneous detections to improve overall task success.
