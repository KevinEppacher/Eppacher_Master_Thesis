...
This experiment addresses RQ5 by evaluating the computational efficiency and real-time feasibility of the proposed system in a real-world deployment setting. Figures~\ref{fig:results:rq5:gpu_vram} and~\ref{fig:results:rq5:openfusion_max_voxel} (see Appendix~\ref{ch:appendix:results:details}) summarize the \ac{GPU} memory consumption of the overall system and an example of a semantic Map for the given total voxel allocation, respectively.
