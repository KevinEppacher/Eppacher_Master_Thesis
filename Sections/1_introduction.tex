...
scalability, and robustness in open-vocabulary, real-world environments~\cite{buschOneMapFind2025,PIGEONVLMDrivenObject2025}. 
...
\begin{table}[H]
    ...
    & High GPU cost or simulation-only evaluation; limited deployability on mobile robots. \\
...
\begin{enumerate}
    ...
    framework?} \\
    This aspect is assessed using \ac{FPS}, GPU and CPU utilization,
